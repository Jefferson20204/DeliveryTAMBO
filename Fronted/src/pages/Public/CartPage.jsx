  ...
  const handlePayment = () => {
    ...
    const orderData = {
      ...
      delivery: {
        ...
        ...(deliveryMethod === "store" && { store: selectedStore }),
        ...(deliveryMethod === "delivery" && { address: deliveryAddress }),
      },
      tip: {
        option: tipOption,
        ...(tipOption === "percent" && { percentage: tipPercent }),
        ...(tipOption === "manual" && { amount: parseFloat(tipManual) }),
        total: tipAmount,
      },
      cart: {
        items: cartItems,
        ...
        <div className="cart-column">
          {!userInfo.email ? (
            <Card
              ...
              buttons={
                <Button fullWidth={false} onClick={() => navigate("/v1/login")}>
                  Iniciar Sesión
                </Button>
              }
            >
